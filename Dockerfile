...
# Inter is the primary font for bot_core.generate_stat_card() (Advanced tier
# image cards) - gives the cards their premium look. fonts-dejavu-core stays
# installed as the fallback _find_font() drops to if Inter is ever missing.
RUN apt-get update \
